...
use uuid::Uuid;
use super::default_repository::duuid::DUUID;
use super::default_repository::duuid::Response;
use super::repository::Header;
use super::default_repository::duuid::Meta;
...
pub fn configure_v1(config: &mut ServiceConfig) {
    config.service(authorize)
            ...
            .service(approve)
            .service(deny)
            .service(for_user_client)
            .service(store)
            .service(update)
            .service(issue_token)
            .service(refresh)
            .service(for_user_token)
...
/// Authorize Client ID
///
/// To check is Client ID authorize or not
#[utoipa::path(
    get,
    ...
    responses(
        ...
        (status = 200, description = "OK", content_type = "application/json", body = Response, content_type = "application/json",
            example = json!({"status": StatusCode::OK.as_u16(), "message": ""})),
...
#[get("/oauth/authorize")]
pub async fn authorize(req: HttpRequest) -> Result<impl Responder> {
    let string = Alphanumeric.sample_string(&mut rand::thread_rng(), 256);
    println!("Random string 2: {}", string);
    println!("{:?}", req);  
    ...
    let resp = Response {
        ...
        meta: Some(Meta { count: 0, offset: 0, page: 0, limit: 0 }),
...
pub async fn approve(_req: HttpRequest) -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
pub async fn deny(_req: HttpRequest) -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
#[get("/oauth/clients")]
pub async fn for_user_client() -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
#[post("/oauth/clients")]
pub async fn store() -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
#[put("/oauth/clients")]
pub async fn update() -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
pub async fn destroy_client() -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
#[get("/oauth/token")]
pub async fn issue_token() -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
#[get("/oauth/tokens")]
pub async fn for_user_token() -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
...
pub async fn destroy_token() -> Result<impl Responder> {
    let resp = Response {
        data: Some(DUUID {
            uuid: Uuid::new_v4().to_string(),
        }),
