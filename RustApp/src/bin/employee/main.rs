...
use employee::default_repository::Header;
use employee::default_repository::Meta;
use employee::default_repository::QueryParams;
...
#[openapi(
    ...
    paths(
        ...
        employee::v1::employee::create_employee,
        employee::v1::employee::delete_employee,
        employee::v1::employee::get_employee,
        employee::v1::employee::update_employee,
        employee::v1::employee_department::create_employee_department,
        employee::v1::employee_department::delete_employee_department,
        employee::v1::employee_department::get_employee_department,
        employee::v1::employee_department::update_employee_department,
        employee::v1::employee_division::create_employee_division,
        employee::v1::employee_division::delete_employee_division,
        employee::v1::employee_division::get_employee_division,
        employee::v1::employee_division::update_employee_division,
        employee::v1::employee_directorate::create_employee_directorate,
        employee::v1::employee_directorate::delete_employee_directorate,
        employee::v1::employee_directorate::get_employee_directorate,
        employee::v1::employee_directorate::update_employee_directorate,
        employee::v1::employee_position::create_employee_position,
        employee::v1::employee_position::delete_employee_position,
        employee::v1::employee_position::get_employee_position,
        employee::v1::employee_position::update_employee_position,
        employee::v1::employee_project::create_employee_project,
        employee::v1::employee_project::delete_employee_project,
        employee::v1::employee_project::get_employee_project,
        employee::v1::employee_project::update_employee_project,
    ), components(schemas(
        CustomDate,
        DataValue,
        EmployeeDivision,
