...
/// Create Project Survey Feedback
///
/// To create new project survey feedback data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/projects/survey/feedback",
    params(Header),
    responses(
    ...
    tag = "Project Survey Feedback"
)]
#[post("/v1/projects/survey/feedback")]
pub async fn create_project_survey_feedback(
...
/// Delete Project Survey Feedback
///
/// To delete project survey feedback data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/projects/survey/feedback",
...
#[delete("/v1/projects/survey/feedback")]
pub async fn delete_project_survey_feedback(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Get Project Survey Feedback
///
/// To get projects survey feedback list
#[utoipa::path(
    get,
    context_path = "/v1",
    path = "/projects/survey/feedback",
...
#[get("/v1/projects/survey/feedback")]
pub async fn get_project_survey_feedback(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Update Project Survey Feedback
///
/// To update project survey feedback data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/projects/survey/feedback",
...
#[put("/v1/projects/survey/feedback")]
pub async fn update_project_survey_feedback(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
