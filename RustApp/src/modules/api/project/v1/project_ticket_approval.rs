...
/// Create Project Ticket Approval
///
/// To create new project ticket approval data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/projects/tickets/approval",
    params(Header),
    responses(
    ...
    tag = "Project Ticket Approval"
)]
#[post("/v1/projects/tickets/approval")]
pub async fn create_project_ticket_approval(
...
#[delete("/v1/projects/tickets/approval")]
pub async fn delete_project_ticket_approval(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Get Project Ticket Approval
///
/// To get projects ticket approval list
#[utoipa::path(
    get,
    context_path = "/v1",
    path = "/projects/tickets/approval",
...
#[get("/v1/projects/tickets/approval")]
pub async fn get_project_ticket_approval(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Update Project Ticket Approval
///
/// To update project ticket approval data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/projects/tickets/approval",
...
#[put("/v1/projects/tickets/approval")]
pub async fn update_project_ticket_approval(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
