...
///
/// To create new project request data
#[utoipa::path(
    post,
    context_path = "/v1",
...
#[delete("/v1/projects/request")]
pub async fn delete_project_request(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
#[put("/v1/projects/request")]
pub async fn update_project_request(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
