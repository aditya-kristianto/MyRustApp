...
/// Create Project Survey Question
///
/// To create new project survey question data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/projects/survey/question",
    params(Header),
    responses(
    ...
    tag = "Project Survey Question"
)]
#[post("/v1/projects/survey/question")]
pub async fn create_project_survey_question(
...
/// Delete Project Survey Question
///
/// To delete project survey question data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/projects/survey/question",
...
#[delete("/v1/projects/survey/quesiton")]
pub async fn delete_project_survey_question(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Get Project Survey Question
///
/// To get projects survey question list
#[utoipa::path(
    get,
    context_path = "/v1",
    path = "/projects/survey/question",
...
#[get("/v1/projects/survey/question")]
pub async fn get_project_survey_question(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Update Project Survey Question
///
/// To update project survey question data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/projects/survey/question",
...
#[put("/v1/projects/survey/question")]
pub async fn update_project_survey_question(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
