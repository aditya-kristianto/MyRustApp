...
/// Create Project Survey Answer
///
/// To create new project survey answer data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/projects/survey/answer",
    params(Header),
    responses(
    ...
    tag = "Project Survey Answer"
)]
#[post("/v1/projects/survey/answer")]
pub async fn create_project_survey_answer(
...
/// Delete Project Survey Answer
///
/// To delete project survey answer data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/projects/survey/answer",
...
#[delete("/v1/projects/survey/answer")]
pub async fn delete_project_survey_answer(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Get Project Survey Answer
///
/// To get projects survey answer list
#[utoipa::path(
    get,
    context_path = "/v1",
    path = "/projects/survey/answer",
...
#[get("/v1/projects/survey/answer")]
pub async fn get_project_survey_answer(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Update Project Survey Answer
///
/// To update project survey answer data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/projects/survey/answer",
...
#[put("/v1/projects/survey/answer")]
pub async fn update_project_survey_answer(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
