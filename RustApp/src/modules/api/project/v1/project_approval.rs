...
///
/// To create new project approval data
#[utoipa::path(
    post,
    context_path = "/v1",
...
#[post("/v1/projects/approval")]
pub async fn create_project_approval(
...
///
/// To delete project approval data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/projects/approval",
...
#[get("/v1/projects/approval")]
pub async fn get_project_approval(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
///
/// To update project approval data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/projects/approval",
...
#[put("/v1/projects/approval")]
pub async fn update_project_approval(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
