...
#[utoipa::path(
    ...
    tag = "Employee Project"
)]
#[get("/v1/employee/projects")]
pub async fn get_employee_project(
...
///
/// To create new employee project data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/employee/projects",
...
#[post("/v1/employee/projects")]
pub async fn create_employee_project(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
///
/// To update employee project data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/employee/projects",
...
#[put("/v1/employee/projects")]
pub async fn update_employee_project(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
///
/// To delete employee project data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/employee/projects",
...
#[delete("/v1/employee/projects")]
pub async fn delete_employee_project(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
