...
/// Get Employee Directorate
///
/// To get employee directorate list
#[utoipa::path(
    get,
    context_path = "/v1",
    path = "/employee/directorates",
    params(Header),
    responses(
    ...
    tag = "Employee Directorate"
)]
#[get("/v1/employee/directorates")]
pub async fn get_employee_directorate(
    ...
    let employee = match Employee::get_employee(data.clone()).await {
        Ok(summary) => summary,
        Err(err) => {
            let resp = Response::new(
                None,
                None,
                Some(format!("Error fetching employee: {}", err)),
                None,
    ...
    let employee_json: Vec<String> = employee.iter()
    ...
    let resp = Response::new(
        Some(HashMap::from([(
            "employee".to_string(),
            DataValue::StringArray(employee_json),
        )])),
        None,
        None,
        Some(Meta {
...
/// Create Employee Directorate
///
/// To create new employee directorate data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/employee/directorates",
...
#[post("/v1/employee/directorates")]
pub async fn create_employee_directorate(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Update Employee Directorate
///
/// To update employee directorate data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/employee/directorates",
...
#[put("/v1/employee/directorates")]
pub async fn update_employee_directorate(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Delete Employee Directorate
///
/// To delete employee directorate data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/employee/directorates",
...
#[delete("/v1/employee/directorates")]
pub async fn delete_employee_directorate(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
