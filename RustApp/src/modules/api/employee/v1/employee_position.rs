...
pub async fn get_employee_position(
...
///
/// To create new employee position data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/employee/positions",
...
pub async fn create_employee_position(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
///
/// To update employee position data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/employee/positions",
...
///
/// To delete employee position data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/employee/positions",
...
#[delete("/v1/employee/positions")]
pub async fn delete_employee_position(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
