...
#[utoipa::path(
    ...
    tag = "Employee Division"
)]
#[get("/v1/employee/division")]
pub async fn get_employee_division(
...
///
/// To create new employee division data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/employee/division",
...
#[post("/v1/employee/divisions")]
pub async fn create_employee_division(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
///
/// To update employee division data
#[utoipa::path(
    put,
    context_path = "/v1",
...
#[put("/v1/employee/divisions")]
pub async fn update_employee_division(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
/// Delete Employee Division
///
/// To delete employee division data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/employee/divisions",
...
#[delete("/v1/employee/divisions")]
pub async fn delete_employee_division(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
