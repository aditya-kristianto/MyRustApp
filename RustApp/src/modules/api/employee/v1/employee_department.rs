...
///
/// To get employee department list
#[utoipa::path(
    get,
    context_path = "/v1",
...
///
/// To create new employee department data
#[utoipa::path(
    post,
    context_path = "/v1",
    path = "/employee/departments",
...
#[post("/v1/employee/departments")]
pub async fn create_employee_department(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
///
/// To update employee department data
#[utoipa::path(
    put,
    context_path = "/v1",
    path = "/employee/departments",
...
#[put("/v1/employee/departments")]
pub async fn update_employee_department(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
...
///
/// To delete employee department data
#[utoipa::path(
    delete,
    context_path = "/v1",
    path = "/employee/departments",
...
#[delete("/v1/employee/departments")]
pub async fn delete_employee_department(
    query: Result<web::Query<QueryParams>, Error>,
    data: web::Data<Arc<Client>>,
) -> Result<impl Responder> {
    let query_params;
